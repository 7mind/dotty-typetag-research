...
object TypeInspections {
  def apply[T <: AnyKind : Type](given qctx0: QuoteContext): AbstractReference = {
    new Inspector(0) { val qctx = qctx0 }.buildTypeRef[T]
  }

  def nameDb[T <: AnyKind : Type](given qctx0: QuoteContext): Map[NameReference, Set[NameReference]] = {
